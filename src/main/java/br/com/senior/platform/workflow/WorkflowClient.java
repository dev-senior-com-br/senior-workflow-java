...
/**
 * Client responsável pela comunicação com o serviço de Workflow.
 */
public class WorkflowClient extends BaseClient {
     ...
     * Inicia um processo.
     *
     * @param payload - Payload de entrada com informações necessárias para iniciar o processo.
     ...
     *
     * @param payload - Payload de entrada com informações da instância do processo e dos anexos que serão relacionados.
     * @throws ServiceException - Erro tratado do serviço.
     */
     ...
     *
     * @param payload - Payload de entrada para filtrar os processos recuperados.
     ...
     *
     * @param payload - Payload de entrada para controlar a pesquisa de tarefas.
